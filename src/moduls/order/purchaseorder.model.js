...
const purchaseOrderSchema = new mongoose.Schema({
    orderNumber: {
        type: String,
        // Not required - will be auto-generated by pre-save middleware
        unique: true,
        trim: true,
        uppercase: true
    },
    ...
    subtotal: {
        type: Number,
        // Not required - will be auto-calculated by pre-save middleware
    ...
    createdBy: {
        type: mongoose.Schema.Types.ObjectId,
        ref: 'User'
        // Making it optional since auth middleware might not be implemented yet
    },
    updatedBy: {
        type: mongoose.Schema.Types.ObjectId,
        ref: 'User'
